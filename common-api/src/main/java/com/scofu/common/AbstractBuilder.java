...
public abstract class AbstractBuilder<T, S, U extends AbstractBuilder<T, S, U>>
  ...
  private final Supplier<S> parent;
  private final Consumer<T> consumer;

  protected AbstractBuilder(
      @Nullable T from, @Nullable Supplier<S> parent, @Nullable Consumer<T> consumer) {
    if (parent != null) {
  ...
  protected AbstractBuilder(@Nullable Supplier<S> parent, @Nullable Consumer<T> consumer) {
